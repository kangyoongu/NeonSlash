...
public class PlayerShotGun : MonoBehaviour
{
    ...
    private void Shot()
    {
        SoundManager.Instance.PlayAudio(Clips.PlayerShot, 0.1f);
        for (int i = 0; i < _playerCompo.copyPlayerStat.playerStat.attackNum; i++)
        {
            ...
            Vector3 spreadVec = Random.onUnitSphere * Random.Range(0f, spread) * Mathf.InverseLerp(1f, 6f, _playerCompo.copyPlayerStat.playerStat.attackNum);//나중에 최대 attackNum으로 변경
